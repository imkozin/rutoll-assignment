...
# CORS(app, origins='https://imkozin.github.io', methods=['GET', 'POST', 'PUT', 'DELETE'], allow_headers=['Content-Type'])
CORS(app, methods=['GET', 'POST', 'PUT', 'DELETE'], resources={r"/api/*": {"origins": "https://imkozin.github.io"}}, allow_headers=['Content-Type'])
